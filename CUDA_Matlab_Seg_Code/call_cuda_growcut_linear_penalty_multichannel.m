function [new_label, new_strength, steps, execution_time] =...
    call_cuda_growcut_linear_penalty_multichannel (     channelOne, channelTwo, channelThree, channelFour,...
...
evol_cells_kernel      = parallel.gpu.CUDAKernel('growcut_3D_euclid_4_channels_linear_penalty.ptx',...
                                                 'growcut_3D_euclid_4_channels_linear_penalty.cu',...
                                                 '_Z10evol_cellsPKfS0_S0_S0_S0_PKhPfPhS4_S0_S0_fiiif');

update_old_step_kernel = parallel.gpu.CUDAKernel('growcut_3D_euclid_4_channels_linear_penalty.ptx',...
                                                 'growcut_3D_euclid_4_channels_linear_penalty.cu',...
